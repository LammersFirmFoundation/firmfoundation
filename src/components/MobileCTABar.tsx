 ...
 *
 * Text becomes a third column once ACCEPTS_SMS is on — plenty of homeowners
 * will text a photo of the problem who would never ring a stranger.
 */
const MobileCTABar = () => {
  return (
    <div className={`fixed bottom-0 inset-x-0 z-40 md:hidden grid ${
